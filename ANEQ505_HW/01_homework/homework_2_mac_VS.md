...
![[taxaplot.png|564]]
Nasal and oral samples show similar community compositions. Skin and udder samples are dominated by similar taxa with comparable diversity levels. Fecal samples display the highest diversity with many different bacterial taxa present. The control samples have much simpler compositions with fewer taxa compared to the real samples.
...
Not all samples contain archaea, but the vast majority of them do. Archaea seem to be less abundant in oral and nasal samples compared to other body sites, while fecal samples appear to have higher levels of archaea. Archaea are absent from the controls, which is expected since these control samples would not contain the same microbial communities as the real cow samples.
...
Job ID: 24379204  
Cluster: alpine  
User/Group: [ghazale@colostate.edu](mailto:ghazale@colostate.edu)/[ghazalepgrp@colostate.edu](mailto:ghazalepgrp@colostate.edu)  
State: COMPLETED (exit code 0)  
Nodes: 1  
Cores per node: 8  
CPU Utilized: 03:10:23  
CPU Efficiency: 10.97% of 1-04:55:36 core-walltime  
Job Wall-clock time: 03:36:57  
Memory Utilized: 8.20 GB  
Memory Efficiency: 27.33% of 30.00 GB (3.75 GB/core)